...
public class AnalysisDataActivity extends BaseActivity
    ...
    private static final String TAG = AnalysisDataActivity.class.getSimpleName();
    String mTitle;
    String mType;
    ...
    private void initTitle() {
        ...
        mTopBarRightTv.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                View convertView = LayoutInflater.from(AnalysisDataActivity.this).inflate(R.layout.activity_select_filter, null);
                new BlackCarFilterActivity(AnalysisDataActivity.this, convertView, lineView.getBottom(), "analysis").showAsDropDown(lineView);
            }
        });
    }
...
//        });
    ...
    public BarData getBarData() {
        ...
        barDataSet.setColors(new int[]{R.color.chart_purple, R.color.chart_blue, R.color.chart_gray, R.color.chart_green, R.color.chart_red, R.color.chart_red,R.color.chart_green, R.color.chart_red,R.color.chart_green }, AnalysisDataActivity.this);
