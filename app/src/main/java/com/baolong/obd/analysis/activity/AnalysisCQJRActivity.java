 ...
 * OBD：车企接入统计
 */
public class AnalysisCQJRActivity extends BaseActivity implements CQJRContract.View {
    private static final String TAG = AnalysisCQJRActivity.class.getSimpleName();
    ...
    private CQJRPresenter mPresenter;
    private List<CQJRModel> mItems = new ArrayList<>();
    ...
    private void initTitle() {
        ((ImageView) this.findViewById(R.id.image_title_back)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AnalysisCQJRActivity.this.onBackPressed();
            }
        });
...
//        });
    ...
    private void showDataOnChart() {
        ...
        final CLJRMarkerView mv = new CLJRMarkerView(this, R.layout.chart_marker_view, "车辆数：", mChart, mXValues);
    ...
    private void setAxisXBottom() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            if (!TextUtils.isEmpty(mItems.get(i).getSszz())) {
                valuesX.add(mItems.get(i).getSszz());
            } else {
                valuesX.add("未知");
            }
        }
    ...
    public BarData getBarData() {
        ...
        //多色
        //barDataSet.setColors(new int[]{R.color.chart_purple, R.color.chart_blue, R.color.chart_gray, R.color.chart_green, R.color.chart_red, R.color.chart_red, R.color.chart_green, R.color.chart_red, R.color.chart_green}, AnalysisCQJRActivity.this);
...
//        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analysis_cqjr);
        ...
        mPresenter = new CQJRPresenter(this);
    ...
    @Override
    public void setPresenter(CQJRContract.Presenter paramT) {
    ...
    public void setData(List<CQJRModel> paramList) {
        //ToastUtils.shortToast(paramString);
