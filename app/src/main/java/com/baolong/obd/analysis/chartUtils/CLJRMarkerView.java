...
public class CLJRMarkerView extends MarkerView {//继承MarkerVIew
     ...
     */
    public CLJRMarkerView(Context context, int layoutResource, String countName, BarChart lineChart, ArrayList<String> xValue) {
