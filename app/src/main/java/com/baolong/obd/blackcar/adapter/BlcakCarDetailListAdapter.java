...
public class BlcakCarDetailListAdapter extends RecyclerView.Adapter<BlcakCarDetailListAdapter.ViewHolder> {
    private Context mContext;
    private View.OnClickListener mOnItemClickListener;
    private List<KeyNameValueModel> mLists;

    public BlcakCarDetailListAdapter(Context paramContext, View.OnClickListener paramOnClickListener) {
